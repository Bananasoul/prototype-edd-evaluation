...
const I18N = {
    fr: {
        ...
        intro_text: "Vous allez répondre à 4 questionnaires standardisés. Vos réponses sont anonymes et confidentielles.",
        ...
        // EVA
        eva_title: "EVA — Échelle Visuelle Analogique",
        eva_subtitle: "Évaluation de l'intensité de la douleur",
        eva_instruction: "Indiquez l'intensité de votre douleur en déplaçant le curseur sur la ligne ci-dessous.",
        eva_anchor_left: "Aucune douleur",
        eva_anchor_right: "Pire douleur imaginable",
        eva_tap_instruction: "Touchez ou glissez sur la ligne pour indiquer votre niveau de douleur",
        dash_eva_title: "Échelle Visuelle Analogique",
        eva_no_pain: "Pas de douleur",
        eva_mild: "Douleur légère",
        eva_moderate: "Douleur modérée",
        eva_severe: "Douleur sévère",
        eva_worst: "Douleur très sévère",
        eva_no_pain_desc: "EVA 0-10 mm : aucune douleur significative.",
        eva_mild_desc: "EVA 11-30 mm : douleur légère, peu invalidante.",
        eva_moderate_desc: "EVA 31-60 mm : douleur modérée nécessitant une attention thérapeutique.",
        eva_severe_desc: "EVA 61-80 mm : douleur sévère, impact important sur les activités.",
        eva_worst_desc: "EVA > 80 mm : douleur très sévère, prise en charge urgente recommandée.",
    ...
    de: {
        ...
        intro_text: "Sie werden 4 standardisierte Fragebögen beantworten. Ihre Antworten sind anonym und vertraulich.",
        ...
        eva_title: "VAS — Visuelle Analogskala",
        eva_subtitle: "Bewertung der Schmerzintensität",
        eva_instruction: "Geben Sie Ihre Schmerzintensität an, indem Sie den Schieberegler auf der Linie bewegen.",
        eva_anchor_left: "Kein Schmerz",
        eva_anchor_right: "Schlimmster vorstellbarer Schmerz",
        eva_tap_instruction: "Berühren oder gleiten Sie auf der Linie, um Ihr Schmerzniveau anzugeben",
        dash_eva_title: "Visuelle Analogskala",
        eva_no_pain: "Kein Schmerz",
        eva_mild: "Leichter Schmerz",
        eva_moderate: "Mäßiger Schmerz",
        eva_severe: "Starker Schmerz",
        eva_worst: "Sehr starker Schmerz",
        eva_no_pain_desc: "VAS 0-10 mm: kein signifikanter Schmerz.",
        eva_mild_desc: "VAS 11-30 mm: leichter, kaum einschränkender Schmerz.",
        eva_moderate_desc: "VAS 31-60 mm: mäßiger Schmerz, therapeutische Aufmerksamkeit erforderlich.",
        eva_severe_desc: "VAS 61-80 mm: starker Schmerz, erhebliche Beeinträchtigung der Aktivitäten.",
        eva_worst_desc: "VAS > 80 mm: sehr starker Schmerz, dringende Behandlung empfohlen.",
